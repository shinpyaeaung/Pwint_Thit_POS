...
Phases 1–18 are verified, including product/catalog, suppliers, purchasing, shipments, landed-cost allocation the shared Cost Journey UI, goods receiving, movement-controlled inventory, batch/expiry history, and transactional FIFO POS with payments and invoices, and failure-tested explicit checkout transactions, and permission-enforced below-cost approvals recorded atomically in immutable approval/audit history, and customer management, special unit pricing and live credit/payment ledgers, and movement-controlled damage/missing stock, reduced damaged sales, returns, linked exchanges and audited refunds, and immutable expense offsets with actual-landed-cost gross/net profit. Cost Journey selling-price/profit scenarios remain unsaved estimates; POS invoices are recorded sales. Preserve historical rates, exact amounts, ledger-based payment status and immutable finalized costing snapshots. Receiving reconciles confirmed sellable quantities and transfers landed totals into batch costs. All inventory changes must originate from immutable movements or controlled adjustments; sales/profit must never fall back to supplier purchase price. Wait for the user’s next phase scope before starting another module. Keep the light-only appearance; the user rejected theme switching. Use pnpm. Do not start unrelated business modules.
