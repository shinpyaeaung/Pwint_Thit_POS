...
export function DataTable<T>({ columns, rows, rowKey, caption, loading, error, onRetry, empty, pageSize = 10 }: { columns: Column<T>[]; rows: T[]; rowKey: (row: T) => string; caption: string; loading?: boolean; error?: string; onRetry?: () => void; empty?: ReactNode; pageSize?: number }) {
