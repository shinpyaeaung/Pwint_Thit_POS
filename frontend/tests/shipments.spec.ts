...
test('shipment goods, transportation timeline, expenses and restricted staff access',async({page,browser})=>{
 ...
 const product=await page.request.post('/api/v1/products',{headers,data:{sku:`SH-${suffix}`,name:`Shipment tea ${suffix}`,base_unit_code:'BOTTLE',is_active:true,packaging:[{unit_code:'BOTTLE',units_per_pack:'1',is_default_purchase:true,is_default_sale:true},{unit_code:'CARTON',units_per_pack:'12',is_default_purchase:false,is_default_sale:false}]}});expect(product.status()).toBe(201)
